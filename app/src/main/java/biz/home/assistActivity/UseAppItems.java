...
public class UseAppItems extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String data= "<html>1、服务条款的确认和接纳\n" +
                ...
                "　　如发生服务条款与中华人民共和国法律相抵触时，则这些条款将完全按法律规定重新解释，而其它条款则依旧保持约束力。</html>";
        try {
//            webView.loadData(URLEncoder.encode(data,"utf-8"),"text/html","utf-8");
                ...
                if(str.equals("companyWebsize")){
                        webView.loadUrl("http://www.4350.biz/Account/Login2.aspx");
                        title.setText("公司官网");
                }else if(str.equals("userLaws")){
                        webView.loadUrl("file:///android_asset/useAppItems.html");
                        title.setText("请仔细阅读使用条款");
                }else{
                        title.setText("百度");
